      ...
      <div className="not-prose grid grid-cols-1 gap-8 sm:grid-cols-2">
        ...
        >
          <div onMouseMove={handleMouseMove}>
            ...
            <div className="pointer-events-none">
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-r opacity-0 transition duration-300 group-hover:opacity-100 to-[#161648] from-[#0c5553]" style={{ maskImage: `radial-gradient(180px at ${cursorPosition.x}px ${cursorPosition.y}px, white, transparent)`}}></div>
            </div>
            ...
            <div className="relative rounded-2xl px-4 pb-4 pt-16">
              ...
              <p className="mt-1 font-light text-sm text-zinc-400">
                Define your statement from a list of predefined data sources and create your attestation.
              </p>
            </div>
          </div>
        </Link>
        ...
        <Link
          ...
          <div onMouseMove={handleMouseMove}>
            ...
            <div className="pointer-events-none">
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-r opacity-0 transition duration-300 group-hover:opacity-100 from-[#161648] to-[#0c5553]" style={{ maskImage: `radial-gradient(180px at ${cursorPosition.x}px ${cursorPosition.y}px, white, transparent)`}}></div>
            </div>
            ...
            <div className="relative rounded-2xl px-4 pb-4 pt-16">
              ...
              <p className="mt-1 font-light text-sm text-zinc-400">
                Verify a given attestation and explore the details of the authentified statement.
              </p>
            </div>
          </div>
        </Link>
